export const translations = {
  en: {
    ...
    hero: {
      title: 'Iroxivor: Intelligent Trades Executed Globally',
      volume: '980M+',
      description: 'Experience the evolution of digital wealth with Iroxivor - the official AI-driven trading platform trusted by investors worldwide',
      rating: '4.9/5',
      reviews: 'Based on 12,847 verified reviews',
      formTitle: 'Join Iroxivor - Exclusive Access',
    ...
    whyChoose: {
      title: 'Why Traders Choose Iroxivor?',
      description: 'Iroxivor equips forward-thinking investors',
    ...
    features: {
      ...
      title: 'How Iroxivor Is Redefining the Future?',
      description: 'Iroxivor steps beyond conventional trading boundaries with AI-powered precision',
    ...
    activeTraders: {
      ...
      description: 'Iroxivor Traders: Trade Smarter, Grow Steadier',
      totalEarnings: 'TOTAL EARNINGS',
      pastLevel: 'in past level',
      viewProfile: 'View Profile',
      joinNow: 'JOIN NOW',
      joinText: 'Join thousands of Iroxivor investors worldwide'
    },
    security: {
    ...
    timer: {
      ...
      description: 'Start your Iroxivor trading journey',
      days: 'Days',
      hours: 'Hours',
      minutes: 'Minutes',
      seconds: 'Seconds',
    ...
    faq: {
      ...
      a2: 'Most platforms react - Iroxivor anticipates',
      q3: 'How Does Iroxivor Protect Data?',
      a3: 'Security forms the backbone',
      q4: 'Is Platform Suitable for Beginners?',
      a4: 'Absolutely. Designed for every level'
    },
    footer: {
      description: 'Iroxivor - Advanced AI-driven trading ecosystem trusted by investors worldwide',
      ...
      copyright: '© 2025 Iroxivor. All rights reserved.'
    }
  },
  de: {
    ...
    whyChoose: { title: 'Warum Iroxivor?', description: 'Iroxivor stattet Investoren aus', feature1Title: 'Intelligenz', feature1Desc: 'Durch AI', feature2Title: 'Globale Expertise', feature2Desc: 'Weltweites Netzwerk', feature3Title: 'Schnelle Ausfuhrung', feature3Desc: 'Millisekunden zahlen', startTrading: 'Handel Starten' },
    ...
    features: { badge: 'VERTRAUENSWURDIG', title: 'Wie Iroxivor?', description: 'Uber Grenzen hinaus', feature1Title: 'Sicherheit', feature1Desc: 'Ihr Kapital', feature2Title: 'Ultra-Schnell', feature2Desc: 'In der Welt', learnMore: 'Mehr Erfahren', ctaText: 'Bereit?', getStartedNow: 'JETZT STARTEN' },
    ...
    faq: { badge: 'HAUFIG GEFRAGT', title: 'FAQ', description: 'Alles uber Iroxivor', q1: 'Was Ist Iroxivor?', a1: 'Handels-Okosystem', q2: 'Warum Die Plattform?', a2: 'Iroxivor antizipiert', q3: 'Wie Schutzt Iroxivor?', a3: 'Sicherheit', q4: 'Ist Die Plattform Geeignet?', a4: 'Absolut' },
    footer: { description: 'Handels-Okosystem', quickLinks: 'SCHNELLLINKS', home: 'Startseite', advantages: 'Vorteile', testimonials: 'Erfahrungsberichte', faq: 'FAQ', aboutUs: 'Uber Uns', contact: 'Kontakt', resources: 'RESSOURCEN', privacy: 'Datenschutz', terms: 'Nutzungsbedingungen', contactTitle: 'KONTAKT', support: 'UNTERSTUTZUNG', support247: '24/7 Verfugbar', coverage: 'ABDECKUNG', countries: '150+ Lander', copyright: '© 2025 Iroxivor' }
  },
  sv: {
    ...
    whyChoose: { title: 'Varfor Iroxivor?', description: 'Iroxivor utrustar investerare', feature1Title: 'Intelligens', feature1Desc: 'Genom AI', feature2Title: 'Global Expertis', feature2Desc: 'Varldsomspaннande natverk', feature3Title: 'Blixtsnabb', feature3Desc: 'Millisekunder', startTrading: 'Borja Handla' },
    ...
    features: { badge: 'PALITLIG', title: 'Hur Iroxivor?', description: 'Ga bortom granser', feature1Title: 'Sakerhet', feature1Desc: 'Ditt kapital', feature2Title: 'Ultrahog', feature2Desc: 'I handelsvarлden', learnMore: 'Las Mer', ctaText: 'Redo?', getStartedNow: 'KOM IGANG NU' },
    ...
    faq: { badge: 'VANLIGA FRAGOR', title: 'FAQ', description: 'Allt om Iroxivor', q1: 'Vad Ar Iroxivor?', a1: 'Handelsekosystem', q2: 'Varfor Plattformen?', a2: 'Iroxivor forutser', q3: 'Hur Skyddar Iroxivor?', a3: 'Sakerhet', q4: 'Ar Plattformen Lamplig?', a4: 'Absolut' },
    footer: { description: 'Handelsekosystem', quickLinks: 'SNABBLANKAR', home: 'Hem', advantages: 'Fordelar', testimonials: 'Vittnesmal', faq: 'FAQ', aboutUs: 'Om Oss', contact: 'Kontakt', resources: 'RESURSER', privacy: 'Integritetspolicy', terms: 'Anvandarvillkor', contactTitle: 'KONTAKT', support: 'SUPPORT', support247: '24/7 Tillganglig', coverage: 'TACKNING', countries: '150+ Lander', copyright: '© 2025 Iroxivor' }
  },
  no: {
    ...
    whyChoose: { title: 'Hvorfor Iroxivor?', description: 'Iroxivor utstyrer investorer', feature1Title: 'Intelligens', feature1Desc: 'Gjennom AI', feature2Title: 'Global Ekspertise', feature2Desc: 'Verdensomspennende nettverk', feature3Title: 'Lynrask', feature3Desc: 'Millisekunder', startTrading: 'Start Handel' },
    ...
    features: { badge: 'PALITELIG', title: 'Hvordan Iroxivor?', description: 'Ga utover grenser', feature1Title: 'Sikkerhet', feature1Desc: 'Din kapital', feature2Title: 'Ultrarask', feature2Desc: 'I handelsverdenen', learnMore: 'Les Mer', ctaText: 'Klar?', getStartedNow: 'BEGYNN NA' },
    ...
    faq: { badge: 'VANLIGE SPORSMAL', title: 'FAQ', description: 'Alt om Iroxivor', q1: 'Hva Er Iroxivor?', a1: 'Handelsokosystem', q2: 'Hvorfor Plattformen?', a2: 'Iroxivor forutser', q3: 'Hvordan Beskytter Iroxivor?', a3: 'Sikkerhet', q4: 'Er Plattformen Egnet?', a4: 'Absolutt' },
    footer: { description: 'Handelsokosystem', quickLinks: 'HURTIGLENKER', home: 'Hjem', advantages: 'Fordeler', testimonials: 'Vitnesmal', faq: 'FAQ', aboutUs: 'Om Oss', contact: 'Kontakt', resources: 'RESSURSER', privacy: 'Personvern', terms: 'Vilkar', contactTitle: 'KONTAKT', support: 'STOTTE', support247: '24/7 Tilgjengelig', coverage: 'DEKNING', countries: '150+ Land', copyright: '© 2025 Iroxivor' }
  },
  ja: {
    ...
    whyChoose: { title: 'なぜIroxivor?', description: 'Iroxivorは投資家を装備', feature1Title: 'インテリジェンス', feature1Desc: 'AIを通じて', feature2Title: 'グローバル専門知識', feature2Desc: '世界的ネットワーク', feature3Title: '超高速', feature3Desc: 'ミリ秒', startTrading: '取引を始める' },
    liveTrading: { badge: 'エキスパート', title: 'ライブ取引', subtitle: 'リアルタイム市場', liveDashboard: 'ライブダッシュボード', executedTrade: 'BTC/USDT取引', ago: '前' },
    features: { badge: '信頼できる', title: 'Iroxivorとは?', description: '境界を越えて', feature1Title: 'セキュリティ', feature1Desc: 'あなたの資本', feature2Title: '超高速', feature2Desc: '取引の世界で', learnMore: '詳細', ctaText: '準備はいいですか?', getStartedNow: '今すぐ始める' },
    ...
    faq: { badge: 'よくある質問', title: 'FAQ', description: 'Iroxivorについて', q1: 'Iroxivorとは?', a1: '取引エコシステム', q2: 'なぜプラットフォーム?', a2: 'Iroxivorは予測', q3: 'どのように保護?', a3: 'セキュリティ', q4: 'プラットフォームは適切?', a4: '絶対に' },
    footer: { description: '取引エコシステム', quickLinks: 'クイックリンク', home: 'ホーム', advantages: '利点', testimonials: '推薦文', faq: 'FAQ', aboutUs: '私たちについて', contact: '連絡先', resources: 'リソース', privacy: 'プライバシー', terms: '利用規約', contactTitle: '連絡先', support: 'サポート', support247: '24/7利用可能', coverage: 'カバレッジ', countries: '150+カ国', copyright: '© 2025 Iroxivor' }
  },
  ko: {
    ...
    whyChoose: { title: '왜 Iroxivor?', description: 'Iroxivor는 투자자를 장비', feature1Title: '인텔리전스', feature1Desc: 'AI를 통해', feature2Title: '글로벌 전문성', feature2Desc: '전 세계 네트워크', feature3Title: '초고속', feature3Desc: '밀리초', startTrading: '거래 시작' },
    liveTrading: { badge: '전문가', title: '라이브 거래', subtitle: '실시간 시장', liveDashboard: '라이브 대시보드', executedTrade: 'BTC/USDT 거래', ago: '전' },
    features: { badge: '신뢰할 수 있는', title: 'Iroxivor란?', description: '경계를 넘어', feature1Title: '보안', feature1Desc: '귀하의 자본', feature2Title: '초고속', feature2Desc: '거래 세계에서', learnMore: '더 알아보기', ctaText: '준비 되셨나요?', getStartedNow: '지금 시작' },
    ...
    faq: { badge: '자주 묻는 질문', title: 'FAQ', description: 'Iroxivor에 대해', q1: 'Iroxivor란?', a1: '거래 생태계', q2: '왜 플랫폼?', a2: 'Iroxivor는 예측', q3: '어떻게 보호?', a3: '보안', q4: '플랫폼이 적합?', a4: '절대적으로' },
    footer: { description: '거래 생태계', quickLinks: '빠른 링크', home: '홈', advantages: '이점', testimonials: '추천서', faq: 'FAQ', aboutUs: '회사 소개', contact: '연락처', resources: '리소스', privacy: '개인정보', terms: '이용약관', contactTitle: '연락처', support: '지원', support247: '24/7 사용 가능', coverage: '커버리지', countries: '150개 이상의 국가', copyright: '© 2025 Iroxivor' }
  },
  it: {
    ...
    whyChoose: { title: 'Perche Iroxivor?', description: 'Iroxivor equipaggia gli investitori', feature1Title: 'Intelligenza', feature1Desc: 'Attraverso l\'AI', feature2Title: 'Competenza Globale', feature2Desc: 'Rete mondiale', feature3Title: 'Ultra Veloce', feature3Desc: 'Millisecondi', startTrading: 'Inizia a Fare Trading' },
    ...
    features: { badge: 'AFFIDABILE', title: 'Come Iroxivor?', description: 'Oltre i confini', feature1Title: 'Sicurezza', feature1Desc: 'Il tuo capitale', feature2Title: 'Ultra Veloce', feature2Desc: 'Nel mondo del trading', learnMore: 'Scopri di Piu', ctaText: 'Pronto?', getStartedNow: 'INIZIA ORA' },
    ...
    faq: { badge: 'DOMANDE FREQUENTI', title: 'FAQ', description: 'Tutto su Iroxivor', q1: 'Cos\'e Iroxivor?', a1: 'Ecosistema di trading', q2: 'Perche la Piattaforma?', a2: 'Iroxivor anticipa', q3: 'Come Protegge Iroxivor?', a3: 'Sicurezza', q4: 'La Piattaforma e Adatta?', a4: 'Assolutamente' },
    footer: { description: 'Ecosistema di trading', quickLinks: 'LINK RAPIDI', home: 'Home', advantages: 'Vantaggi', testimonials: 'Testimonianze', faq: 'FAQ', aboutUs: 'Chi Siamo', contact: 'Contatti', resources: 'RISORSE', privacy: 'Privacy', terms: 'Termini', contactTitle: 'CONTATTO', support: 'SUPPORTO', support247: '24/7 Disponibile', coverage: 'COPERTURA', countries: '150+ Paesi', copyright: '© 2025 Iroxivor' }
  },
  fr: {
    ...
    whyChoose: { title: 'Pourquoi Iroxivor?', description: 'Iroxivor equipe les investisseurs', feature1Title: 'Intelligence', feature1Desc: 'Par l\'IA', feature2Title: 'Expertise Mondiale', feature2Desc: 'Reseau mondial', feature3Title: 'Ultra Rapide', feature3Desc: 'Millisecondes', startTrading: 'Commencer a Negocier' },
    ...
    features: { badge: 'FIABLE', title: 'Comment Iroxivor?', description: 'Au-dela des frontieres', feature1Title: 'Securite', feature1Desc: 'Votre capital', feature2Title: 'Ultra Rapide', feature2Desc: 'Dans le monde du trading', learnMore: 'En Savoir Plus', ctaText: 'Pret?', getStartedNow: 'COMMENCER MAINTENANT' },
    ...
    faq: { badge: 'QUESTIONS FREQUENTES', title: 'FAQ', description: 'Tout sur Iroxivor', q1: 'Qu\'est-ce qu\'Iroxivor?', a1: 'Ecosysteme de trading', q2: 'Pourquoi la Plateforme?', a2: 'Iroxivor anticipe', q3: 'Comment Protege Iroxivor?', a3: 'Securite', q4: 'La Plateforme est-elle Adaptee?', a4: 'Absolument' },
    footer: { description: 'Ecosysteme de trading', quickLinks: 'LIENS RAPIDES', home: 'Accueil', advantages: 'Avantages', testimonials: 'Temoignages', faq: 'FAQ', aboutUs: 'A Propos', contact: 'Contact', resources: 'RESSOURCES', privacy: 'Confidentialite', terms: 'Conditions', contactTitle: 'CONTACT', support: 'SUPPORT', support247: '24/7 Disponible', coverage: 'COUVERTURE', countries: '150+ Pays', copyright: '© 2025 Iroxivor' }
  },
  es: {
    ...
    whyChoose: { title: 'Por Que Iroxivor?', description: 'Iroxivor equipa a los inversores', feature1Title: 'Inteligencia', feature1Desc: 'A traves de IA', feature2Title: 'Experiencia Global', feature2Desc: 'Red mundial', feature3Title: 'Ultra Rapido', feature3Desc: 'Milisegundos', startTrading: 'Empezar a Operar' },
    ...
    features: { badge: 'CONFIABLE', title: 'Como Iroxivor?', description: 'Mas alla de las fronteras', feature1Title: 'Seguridad', feature1Desc: 'Tu capital', feature2Title: 'Ultra Rapido', feature2Desc: 'En el mundo del trading', learnMore: 'Saber Mas', ctaText: 'Listo?', getStartedNow: 'EMPEZAR AHORA' },
    ...
    faq: { badge: 'PREGUNTAS FRECUENTES', title: 'FAQ', description: 'Todo sobre Iroxivor', q1: 'Que es Iroxivor?', a1: 'Ecosistema de trading', q2: 'Por Que la Plataforma?', a2: 'Iroxivor anticipa', q3: 'Como Protege Iroxivor?', a3: 'Seguridad', q4: 'Es Adecuada la Plataforma?', a4: 'Absolutamente' },
    footer: { description: 'Ecosistema de trading', quickLinks: 'ENLACES RAPIDOS', home: 'Inicio', advantages: 'Ventajas', testimonials: 'Testimonios', faq: 'FAQ', aboutUs: 'Sobre Nosotros', contact: 'Contacto', resources: 'RECURSOS', privacy: 'Privacidad', terms: 'Terminos', contactTitle: 'CONTACTO', support: 'SOPORTE', support247: '24/7 Disponible', coverage: 'COBERTURA', countries: '150+ Paises', copyright: '© 2025 Iroxivor' }
  }
};
