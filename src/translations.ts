export const translations = {
  en: {
    ...
    hero: {
      ...
      volume: '980M+',
      description: 'Experience the evolution of digital wealth with Fenextor',
      rating: '4.9/5',
    ...
    whyChoose: {
      title: 'Why Traders Choose Fenextor?',
      description: 'Fenextor equips forward-thinking investors',
    ...
    features: {
      ...
      title: 'How Fenextor Is Redefining the Future?',
    ...
    timer: {
      ...
      description: 'Start your Fenextor trading journey',
      days: 'Days',
      hours: 'Hours',
      minutes: 'Minutes',
      seconds: 'Seconds',
    ...
    faq: {
      ...
      a2: 'Most platforms react - Fenextor anticipates',
      q3: 'How Does Fenextor Protect Data?',
    ...
    footer: {
      ...
      copyright: '© 2025 Fenextor. All rights reserved.'
    }
  },
  de: {
    ...
    whyChoose: { title: 'Warum Fenextor?', description: 'Fenextor stattet Investoren aus', feature1Title: 'Intelligenz', feature1Desc: 'Durch AI', feature2Title: 'Globale Expertise', feature2Desc: 'Weltweites Netzwerk', feature3Title: 'Schnelle Ausfuhrung', feature3Desc: 'Millisekunden zahlen', startTrading: 'Handel Starten' },
    ...
    features: { badge: 'VERTRAUENSWURDIG', title: 'Wie Fenextor?', description: 'Uber Grenzen hinaus', feature1Title: 'Sicherheit', feature1Desc: 'Ihr Kapital', feature2Title: 'Ultra-Schnell', feature2Desc: 'In der Welt', learnMore: 'Mehr Erfahren', ctaText: 'Bereit?', getStartedNow: 'JETZT STARTEN' },
    ...
    faq: { badge: 'HAUFIG GEFRAGT', title: 'FAQ', description: 'Alles uber Fenextor', q1: 'Was Ist Fenextor?', a1: 'Handels-Okosystem', q2: 'Warum Die Plattform?', a2: 'Fenextor antizipiert', q3: 'Wie Schutzt Fenextor?', a3: 'Sicherheit', q4: 'Ist Die Plattform Geeignet?', a4: 'Absolut' },
    footer: { description: 'Handels-Okosystem', quickLinks: 'SCHNELLLINKS', home: 'Startseite', advantages: 'Vorteile', testimonials: 'Erfahrungsberichte', faq: 'FAQ', aboutUs: 'Uber Uns', contact: 'Kontakt', resources: 'RESSOURCEN', privacy: 'Datenschutz', terms: 'Nutzungsbedingungen', contactTitle: 'KONTAKT', support: 'UNTERSTUTZUNG', support247: '24/7 Verfugbar', coverage: 'ABDECKUNG', countries: '150+ Lander', copyright: '© 2025 Fenextor' }
  },
  sv: {
    ...
    whyChoose: { title: 'Varfor Fenextor?', description: 'Fenextor utrustar investerare', feature1Title: 'Intelligens', feature1Desc: 'Genom AI', feature2Title: 'Global Expertis', feature2Desc: 'Varldsomspaннande natverk', feature3Title: 'Blixtsnabb', feature3Desc: 'Millisekunder', startTrading: 'Borja Handla' },
    ...
    features: { badge: 'PALITLIG', title: 'Hur Fenextor?', description: 'Ga bortom granser', feature1Title: 'Sakerhet', feature1Desc: 'Ditt kapital', feature2Title: 'Ultrahog', feature2Desc: 'I handelsvarлden', learnMore: 'Las Mer', ctaText: 'Redo?', getStartedNow: 'KOM IGANG NU' },
    ...
    faq: { badge: 'VANLIGA FRAGOR', title: 'FAQ', description: 'Allt om Fenextor', q1: 'Vad Ar Fenextor?', a1: 'Handelsekosystem', q2: 'Varfor Plattformen?', a2: 'Fenextor forutser', q3: 'Hur Skyddar Fenextor?', a3: 'Sakerhet', q4: 'Ar Plattformen Lamplig?', a4: 'Absolut' },
    footer: { description: 'Handelsekosystem', quickLinks: 'SNABBLANKAR', home: 'Hem', advantages: 'Fordelar', testimonials: 'Vittnesmal', faq: 'FAQ', aboutUs: 'Om Oss', contact: 'Kontakt', resources: 'RESURSER', privacy: 'Integritetspolicy', terms: 'Anvandarvillkor', contactTitle: 'KONTAKT', support: 'SUPPORT', support247: '24/7 Tillganglig', coverage: 'TACKNING', countries: '150+ Lander', copyright: '© 2025 Fenextor' }
  },
  no: {
    ...
    whyChoose: { title: 'Hvorfor Fenextor?', description: 'Fenextor utstyrer investorer', feature1Title: 'Intelligens', feature1Desc: 'Gjennom AI', feature2Title: 'Global Ekspertise', feature2Desc: 'Verdensomspennende nettverk', feature3Title: 'Lynrask', feature3Desc: 'Millisekunder', startTrading: 'Start Handel' },
    ...
    features: { badge: 'PALITELIG', title: 'Hvordan Fenextor?', description: 'Ga utover grenser', feature1Title: 'Sikkerhet', feature1Desc: 'Din kapital', feature2Title: 'Ultrarask', feature2Desc: 'I handelsverdenen', learnMore: 'Les Mer', ctaText: 'Klar?', getStartedNow: 'BEGYNN NA' },
    ...
    faq: { badge: 'VANLIGE SPORSMAL', title: 'FAQ', description: 'Alt om Fenextor', q1: 'Hva Er Fenextor?', a1: 'Handelsokosystem', q2: 'Hvorfor Plattformen?', a2: 'Fenextor forutser', q3: 'Hvordan Beskytter Fenextor?', a3: 'Sikkerhet', q4: 'Er Plattformen Egnet?', a4: 'Absolutt' },
    footer: { description: 'Handelsokosystem', quickLinks: 'HURTIGLENKER', home: 'Hjem', advantages: 'Fordeler', testimonials: 'Vitnesmal', faq: 'FAQ', aboutUs: 'Om Oss', contact: 'Kontakt', resources: 'RESSURSER', privacy: 'Personvern', terms: 'Vilkar', contactTitle: 'KONTAKT', support: 'STOTTE', support247: '24/7 Tilgjengelig', coverage: 'DEKNING', countries: '150+ Land', copyright: '© 2025 Fenextor' }
  },
  ja: {
    ...
    whyChoose: { title: 'なぜFenextor?', description: 'Fenextorは投資家を装備', feature1Title: 'インテリジェンス', feature1Desc: 'AIを通じて', feature2Title: 'グローバル専門知識', feature2Desc: '世界的ネットワーク', feature3Title: '超高速', feature3Desc: 'ミリ秒', startTrading: '取引を始める' },
    liveTrading: { badge: 'エキスパート', title: 'ライブ取引', subtitle: 'リアルタイム市場', liveDashboard: 'ライブダッシュボード', executedTrade: 'BTC/USDT取引', ago: '前' },
    features: { badge: '信頼できる', title: 'Fenextorとは?', description: '境界を越えて', feature1Title: 'セキュリティ', feature1Desc: 'あなたの資本', feature2Title: '超高速', feature2Desc: '取引の世界で', learnMore: '詳細', ctaText: '準備はいいですか?', getStartedNow: '今すぐ始める' },
    ...
    faq: { badge: 'よくある質問', title: 'FAQ', description: 'Fenextorについて', q1: 'Fenextorとは?', a1: '取引エコシステム', q2: 'なぜプラットフォーム?', a2: 'Fenextorは予測', q3: 'どのように保護?', a3: 'セキュリティ', q4: 'プラットフォームは適切?', a4: '絶対に' },
    footer: { description: '取引エコシステム', quickLinks: 'クイックリンク', home: 'ホーム', advantages: '利点', testimonials: '推薦文', faq: 'FAQ', aboutUs: '私たちについて', contact: '連絡先', resources: 'リソース', privacy: 'プライバシー', terms: '利用規約', contactTitle: '連絡先', support: 'サポート', support247: '24/7利用可能', coverage: 'カバレッジ', countries: '150+カ国', copyright: '© 2025 Fenextor' }
  },
  ko: {
    ...
    whyChoose: { title: '왜 Fenextor?', description: 'Fenextor는 투자자를 장비', feature1Title: '인텔리전스', feature1Desc: 'AI를 통해', feature2Title: '글로벌 전문성', feature2Desc: '전 세계 네트워크', feature3Title: '초고속', feature3Desc: '밀리초', startTrading: '거래 시작' },
    liveTrading: { badge: '전문가', title: '라이브 거래', subtitle: '실시간 시장', liveDashboard: '라이브 대시보드', executedTrade: 'BTC/USDT 거래', ago: '전' },
    features: { badge: '신뢰할 수 있는', title: 'Fenextor란?', description: '경계를 넘어', feature1Title: '보안', feature1Desc: '귀하의 자본', feature2Title: '초고속', feature2Desc: '거래 세계에서', learnMore: '더 알아보기', ctaText: '준비 되셨나요?', getStartedNow: '지금 시작' },
    ...
    faq: { badge: '자주 묻는 질문', title: 'FAQ', description: 'Fenextor에 대해', q1: 'Fenextor란?', a1: '거래 생태계', q2: '왜 플랫폼?', a2: 'Fenextor는 예측', q3: '어떻게 보호?', a3: '보안', q4: '플랫폼이 적합?', a4: '절대적으로' },
    footer: { description: '거래 생태계', quickLinks: '빠른 링크', home: '홈', advantages: '이점', testimonials: '추천서', faq: 'FAQ', aboutUs: '회사 소개', contact: '연락처', resources: '리소스', privacy: '개인정보', terms: '이용약관', contactTitle: '연락처', support: '지원', support247: '24/7 사용 가능', coverage: '커버리지', countries: '150개 이상의 국가', copyright: '© 2025 Fenextor' }
  },
  it: {
    ...
    whyChoose: { title: 'Perche Fenextor?', description: 'Fenextor equipaggia gli investitori', feature1Title: 'Intelligenza', feature1Desc: 'Attraverso l\'AI', feature2Title: 'Competenza Globale', feature2Desc: 'Rete mondiale', feature3Title: 'Ultra Veloce', feature3Desc: 'Millisecondi', startTrading: 'Inizia a Fare Trading' },
    ...
    features: { badge: 'AFFIDABILE', title: 'Come Fenextor?', description: 'Oltre i confini', feature1Title: 'Sicurezza', feature1Desc: 'Il tuo capitale', feature2Title: 'Ultra Veloce', feature2Desc: 'Nel mondo del trading', learnMore: 'Scopri di Piu', ctaText: 'Pronto?', getStartedNow: 'INIZIA ORA' },
    ...
    faq: { badge: 'DOMANDE FREQUENTI', title: 'FAQ', description: 'Tutto su Fenextor', q1: 'Cos\'e Fenextor?', a1: 'Ecosistema di trading', q2: 'Perche la Piattaforma?', a2: 'Fenextor anticipa', q3: 'Come Protegge Fenextor?', a3: 'Sicurezza', q4: 'La Piattaforma e Adatta?', a4: 'Assolutamente' },
    footer: { description: 'Ecosistema di trading', quickLinks: 'LINK RAPIDI', home: 'Home', advantages: 'Vantaggi', testimonials: 'Testimonianze', faq: 'FAQ', aboutUs: 'Chi Siamo', contact: 'Contatti', resources: 'RISORSE', privacy: 'Privacy', terms: 'Termini', contactTitle: 'CONTATTO', support: 'SUPPORTO', support247: '24/7 Disponibile', coverage: 'COPERTURA', countries: '150+ Paesi', copyright: '© 2025 Fenextor' }
  },
  fr: {
    ...
    whyChoose: { title: 'Pourquoi Fenextor?', description: 'Fenextor equipe les investisseurs', feature1Title: 'Intelligence', feature1Desc: 'Par l\'IA', feature2Title: 'Expertise Mondiale', feature2Desc: 'Reseau mondial', feature3Title: 'Ultra Rapide', feature3Desc: 'Millisecondes', startTrading: 'Commencer a Negocier' },
    ...
    features: { badge: 'FIABLE', title: 'Comment Fenextor?', description: 'Au-dela des frontieres', feature1Title: 'Securite', feature1Desc: 'Votre capital', feature2Title: 'Ultra Rapide', feature2Desc: 'Dans le monde du trading', learnMore: 'En Savoir Plus', ctaText: 'Pret?', getStartedNow: 'COMMENCER MAINTENANT' },
    ...
    faq: { badge: 'QUESTIONS FREQUENTES', title: 'FAQ', description: 'Tout sur Fenextor', q1: 'Qu\'est-ce qu\'Fenextor?', a1: 'Ecosysteme de trading', q2: 'Pourquoi la Plateforme?', a2: 'Fenextor anticipe', q3: 'Comment Protege Fenextor?', a3: 'Securite', q4: 'La Plateforme est-elle Adaptee?', a4: 'Absolument' },
    footer: { description: 'Ecosysteme de trading', quickLinks: 'LIENS RAPIDES', home: 'Accueil', advantages: 'Avantages', testimonials: 'Temoignages', faq: 'FAQ', aboutUs: 'A Propos', contact: 'Contact', resources: 'RESSOURCES', privacy: 'Confidentialite', terms: 'Conditions', contactTitle: 'CONTACT', support: 'SUPPORT', support247: '24/7 Disponible', coverage: 'COUVERTURE', countries: '150+ Pays', copyright: '© 2025 Fenextor' }
  },
  es: {
    ...
    whyChoose: { title: 'Por Que Fenextor?', description: 'Fenextor equipa a los inversores', feature1Title: 'Inteligencia', feature1Desc: 'A traves de IA', feature2Title: 'Experiencia Global', feature2Desc: 'Red mundial', feature3Title: 'Ultra Rapido', feature3Desc: 'Milisegundos', startTrading: 'Empezar a Operar' },
    ...
    features: { badge: 'CONFIABLE', title: 'Como Fenextor?', description: 'Mas alla de las fronteras', feature1Title: 'Seguridad', feature1Desc: 'Tu capital', feature2Title: 'Ultra Rapido', feature2Desc: 'En el mundo del trading', learnMore: 'Saber Mas', ctaText: 'Listo?', getStartedNow: 'EMPEZAR AHORA' },
    ...
    faq: { badge: 'PREGUNTAS FRECUENTES', title: 'FAQ', description: 'Todo sobre Fenextor', q1: 'Que es Fenextor?', a1: 'Ecosistema de trading', q2: 'Por Que la Plataforma?', a2: 'Fenextor anticipa', q3: 'Como Protege Fenextor?', a3: 'Seguridad', q4: 'Es Adecuada la Plataforma?', a4: 'Absolutamente' },
    footer: { description: 'Ecosistema de trading', quickLinks: 'ENLACES RAPIDOS', home: 'Inicio', advantages: 'Ventajas', testimonials: 'Testimonios', faq: 'FAQ', aboutUs: 'Sobre Nosotros', contact: 'Contacto', resources: 'RECURSOS', privacy: 'Privacidad', terms: 'Terminos', contactTitle: 'CONTACTO', support: 'SOPORTE', support247: '24/7 Disponible', coverage: 'COBERTURA', countries: '150+ Paises', copyright: '© 2025 Fenextor' }
  }
};
